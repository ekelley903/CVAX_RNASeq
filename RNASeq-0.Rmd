...
The Phoenix yaml file lists reverse stranded as the RNASeq library type, so based on this, I will use counts from Column 4 of the ReadsPerGene.out.tab matrix.
...
cvax_de_data <- DESeqDataSetFromMatrix(
  countData = counts_df,
  colData = col_data,
